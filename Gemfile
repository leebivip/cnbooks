...
gem 'refinerycms-blog', '1.1.0.0.2', :git => 'git://github.com/dsaronin/refinerycms-blog.git'
gem 'refinerycms-galleries', '0.4.0.5', :require => 'galleries', :git => 'git://github.com/dsaronin/refinerycms-galleries.git'
